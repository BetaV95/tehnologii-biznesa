    ...
    <section className="section services-dark" id="services">
      <div className="container">
        <div className="section-heading">
          ...
          <p>
            Автоматизация iiko и Saby, торговое оборудование, техническая
            поддержка и работа с государственными системами — всё, что
            необходимо для запуска и работы торговой точки.
          </p>
        </div>
